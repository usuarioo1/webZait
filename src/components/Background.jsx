...
const LetterGlitch = ({
    ...
    return (
        <div className="relative w-full h-full bg-black overflow-hidden">
            ...
            {outerVignette && (
                <div
                    className="absolute top-0 left-0 w-full h-full pointer-events-none bg-[radial-gradient(circle,_rgba(0,0,0,0)_60%,_rgba(0,0,0,1)_100%)] text-center justify-center items-center text-white flex font-bold text-6xl"
                >Hola visitantes de webzait</div>
            )}
            {centerVignette && (
                <div
